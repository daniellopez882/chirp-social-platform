...
const Input = () => {
  ...
  return (
    <div
      ...
      overflow-y-auto ${loading && "opacity-60"}`}
    >
      <img
      ...
      <div className=" w-full">
        ...
        >
          <textarea
            ...
            rows="1"
            className="resize-none bg-transparent outline-none text-[#d9d9d9] text-lg placeholder-gray-500 tracking-wide w-full pt-2"
          />
